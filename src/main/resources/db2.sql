...
-- 4. TEMPLATE SEATS
-- ================================================
-- Example: 160 seats for 4 screens (IDs 1–4). You can extend as needed.
...
-- 5. MOVIES
-- ================================================
INSERT INTO movies (id, title, language, genre, duration, description, posterUrl) VALUES
(1,'Dune: Part Two','English','Action, Sci-Fi',166,'The sequel to Dune where Paul Atreides unites with the Fremen to seek revenge and shape the fate of the universe.','https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=400&h=600&fit=crop'),
(2,'The Batman Returns','English','Action, Crime',175,'Batman faces new threats in Gotham as corruption deepens and new villains rise.','https://images.unsplash.com/photo-1509347528160-9a9e33742cdb?w=400&h=600&fit=crop'),
(3,'Interstellar Voyage','English','Adventure, Sci-Fi',169,'A team of explorers travels through a wormhole in space to ensure humanity’s survival.','https://images.unsplash.com/photo-1518676590629-3dcbd9c5a5c9?w=400&h=600&fit=crop'),
(4,'The Last Kingdom','English','Drama, History',142,'A historical drama of war, loyalty, and leadership as kingdoms clash for power.','https://images.unsplash.com/photo-1485846234645-a62644f84728?w=400&h=600&fit=crop'),
(5,'Avatar: Water Rise','English','Adventure, Fantasy',180,'Jake Sully and Neytiri protect their family as a new threat emerges from the oceans of Pandora.','https://images.unsplash.com/photo-1502134249126-9f3755a50d78?w=400&h=600&fit=crop');

-- ================================================
-- 6. SHOWS
-- ================================================
INSERT INTO shows (id, movie_id, screen_id, seat_template_id, showTime, totalSeats) VALUES
(1,1,1,1,'2025-11-17 14:00:00',40),
(2,2,2,2,'2025-11-17 16:30:00',40),
(3,3,1,1,'2025-11-17 09:30:00',40),
(4,4,2,2,'2025-11-17 20:30:00',40),
(5,3,1,1,'2025-11-17 18:00:00',40);
...
SELECT * FROM shows WHERE showTime >= CURDATE();
...
(1,1,1,'2025-11-18 14:00:00',40),
(2,2,2,'2025-11-19 16:30:00',40),
(3,1,1,'2025-11-20 09:30:00',40),
(4,2,2,'2025-11-21 20:30:00',40),
(3,1,1,'2025-11-23 18:00:00',40);
...
SELECT b.id AS booking_id, u.username, s.seatCode, s.id AS seat_id
FROM bookings b
